...
public class LogParserParser  {
	...
	public LogParserParser(final String parsingRulesPath, final VirtualChannel channel) throws FileNotFoundException , IOException {
		...
		statusCount.put(LogParserConsts.ERROR_GEN, 0);
		statusCount.put(LogParserConsts.ERROR_BUILD, 0);
    ...
    public LogParserResult parseLog(final AbstractBuild build) throws FileNotFoundException , IOException, InterruptedException {
        ...
        final String error_genLinksFilePath 	 = logDirectory+"/logerror_genLinks.html"; 	
        final String error_buildLinksFilePath 	 = logDirectory+"/logerror_buildLinks.html"; 	
		...
		linkFiles.put(LogParserConsts.ERROR_GEN, error_genLinksFilePath);
		linkFiles.put(LogParserConsts.ERROR_BUILD, error_buildLinksFilePath);
		...
		writers.put(LogParserConsts.ERROR_GEN, new BufferedWriter(new FileWriter(error_genLinksFilePath)));
		writers.put(LogParserConsts.ERROR_BUILD, new BufferedWriter(new FileWriter(error_buildLinksFilePath)));
		...
		writers.put(LogParserConsts.OK, new BufferedWriter(new FileWriter(okLinksFilePath)));
		...
		((BufferedWriter)writers.get(LogParserConsts.ERROR_GEN)).close();
		((BufferedWriter)writers.get(LogParserConsts.ERROR_BUILD)).close();
        ...
        result.setTotalErrors_Gen((Integer)statusCount.get(LogParserConsts.ERROR_GEN));
	result.setTotalErrors_Build((Integer)statusCount.get(LogParserConsts.ERROR_BUILD));
	result.setTotalTotalErrors(result.getTotalErrors()+result.getTotalErrors_Gen()+result.getTotalErrors_Build());
	...
	result.setError_GenLinksFile(error_genLinksFilePath);
	result.setError_BuildLinksFile(error_buildLinksFilePath);
        result.setWarningLinksFile(warningLinksFilePath);
        result.setInfoLinksFile(infoLinksFilePath);
	result.setOkLinksFile(okLinksFilePath);
