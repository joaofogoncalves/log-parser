...
public class LogParserDisplayConsts {
	...
	public LogParserDisplayConsts() {
		...
		colorTable.put(LogParserConsts.ERROR_GEN, "red");
		colorTable.put(LogParserConsts.ERROR_BUILD, "red");
		...
		colorTable.put(LogParserConsts.OK, "green");

		// Icon for each status in the summary
		iconTable.put(LogParserConsts.ERROR, "red.gif");
		iconTable.put(LogParserConsts.ERROR_GEN, "red.gif");
		iconTable.put(LogParserConsts.ERROR_BUILD, "red.gif");
		iconTable.put(LogParserConsts.WARNING, "yellow.gif");
		iconTable.put(LogParserConsts.INFO, "blue.gif");
		iconTable.put(LogParserConsts.OK, "green.gif");

		// How to display in link summary html
		linkListDisplay.put(LogParserConsts.ERROR, "Error");
		linkListDisplay.put(LogParserConsts.ERROR_GEN, "Generation Error");
		linkListDisplay.put(LogParserConsts.ERROR_BUILD, "Build Error");
		...
		linkListDisplayPlural.put(LogParserConsts.ERROR_GEN, "Generation Errors");
		linkListDisplayPlural.put(LogParserConsts.ERROR_BUILD, "Build Errors");
